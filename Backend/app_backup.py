...
def detect_food():
    ...
    try:
       ...
       # 3. YOLO detection
        ...
        # 5. Find highest-confidence detection
        best_box = max(
            result.boxes,
        ...
        # 6. Get food details from database
        conn = get_connection()
        ...
        return jsonify({
           ...
           "confidence": confidence,
           "price": food["Price"],
           "available": str(food["Available"]) == "1"
        })
